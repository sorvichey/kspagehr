                ...
                <div class="col-md-3 col-sm-12 col-12">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <a href="{{url('/seeker')}}"><i class="fa fa-user-circle-o"></i> {{trans("labels.my_profile")}}</a>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <a href="{{url('/seeker/cv')}}"><i class="fa fa-id-badge" aria-hidden="true"></i> {{trans("labels.my_resume")}}</a>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <a href="{{url('/seeker/document')}}"><i class="fa fa-file-text-o" aria-hidden="true"></i>  {{trans("labels.my_document")}}</a>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <a href="{{url('/seeker/reset-password')}}"><i class="fa fa-key" aria-hidden="true"></i> {{trans("labels.change_password")}}</a>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <a href="{{url('/seeker/logout')}}" class="text-danger"><i class="fa fa-sign-out" aria-hidden="true"></i> {{trans("labels.logout")}}</a>
                        </li>
                    </ul>
                </div>
