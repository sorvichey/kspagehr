               ...
               <div class="page-title">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer')}}"><i class="fa fa-user-circle-o"></i>   {{trans('labels.my_profile')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/subscription')}}"><i class="fa fa-money" aria-hidden="true"></i> {{trans('labels.my_subscription')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/job')}}"><i class="fa fa-id-card-o" aria-hidden="true"></i> {{trans('labels.my_job')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/company')}}"><i class="fa fa-first-order" aria-hidden="true"></i> {{trans('labels.my_company')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/search/cv')}}"><i class="fa fa-search" aria-hidden="true"></i> {{trans('labels.find_cv')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/favorite')}}"><i class="fa fa-gratipay" aria-hidden="true"></i> {{trans('labels.favorite_cv')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/reset-password')}}"><i class="fa fa-key" aria-hidden="true"></i> {{trans('labels.change_password')}}</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <a href="{{url('/employer/logout')}}" class="text-danger"><i class="fa fa-sign-out" aria-hidden="true"></i>  {{trans('labels.logout')}}</a>
                            </li>
                        </ul>
                    </div>
