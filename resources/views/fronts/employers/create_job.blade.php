...
@section('content')
    ...
    <div class="border">
            ...
            <form action="{{url('/employer/job/save')}}" method="post">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <label for="job_title" class="control-label">{{trans('labels.job_title')}} <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <label for="closing_date" class="control-label">{{trans('labels.closing_date')}}  <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label for="hire" class="control-label"><b>{{trans('labels.hiring')}}</b></label>
