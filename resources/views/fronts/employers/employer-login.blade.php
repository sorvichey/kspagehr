...
<div class="row">
        <div class="col-md-9">
            ...
            <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('img/'.$logo->photo)}}" alt="logo" title="{{$logo->name}}" class="logo"></a><br>
                        ...
                        <a href="{{url('/employer/register')}}" class="btn btn-success btn-block"><i class="fa fa-hand-o-right" aria-hidden="true"></i> 
                ...
                <div class="col-md-6">  
                    <div class="border">
                        <h3 class="page-title text-center">{{trans("labels.employer_login")}}</h3>  <hr>    
